...
void Text::Render(Renderer& renderer, Shader& shader, const Transform& transform) {
    if ( font) {
        ...
        FontSystem::RenderText(font, textShader, content, transform.position.x, transform.position.y, scale, color);
